...
{
    public class DoubleVerticalShape : Shape
    {
        private Block[,] _blockMatrix;

        public DoubleVerticalShape()
        {
        ...
        public DoubleVerticalShape(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new DoubleVerticalShape(this.Location);
            return shape;
        }
