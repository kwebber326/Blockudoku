...
{
    public class QuadrupleVertical : Shape
    {
        private Block[,] _blockMatrix;

        public QuadrupleVertical()
        {
        ...
        public QuadrupleVertical(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new QuadrupleVertical(this.Location);
            return shape;
        }
