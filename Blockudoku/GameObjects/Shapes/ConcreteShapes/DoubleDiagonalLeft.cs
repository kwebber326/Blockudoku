...
{
    public class DoubleDiagonalLeft : Shape
    {
        private Block[,] _blockMatrix;

        public DoubleDiagonalLeft()
        {
        ...
        public DoubleDiagonalLeft(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new DoubleDiagonalLeft(this.Location);
            return shape;
        }
