...
{
    public class VerticalLBlockDownRight : Shape
    {
        private Block[,] _blockMatrix;

        public VerticalLBlockDownRight()
        {
        ...
        public VerticalLBlockDownRight(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new VerticalLBlockDownRight(this.Location);
            return shape;
        }
