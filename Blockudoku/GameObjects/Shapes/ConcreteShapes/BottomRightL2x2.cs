...
{
    public class BottomRightL2x2 : Shape
    {
        private Block[,] _blockMatrix;

        public BottomRightL2x2()
        {
        ...
        public BottomRightL2x2(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new BottomRightL2x2(this.Location);
            return shape;
        }
