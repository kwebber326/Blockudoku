...
{
    public class TripleVertical : Shape
    {
        private Block[,] _blockMatrix;

        public TripleVertical()
        {
        ...
        public TripleVertical(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new TripleVertical(this.Location);
            return shape;
        }
