...
{
    public class BottomRightL3x2 : Shape
    {
        private Block[,] _blockMatrix;

        public BottomRightL3x2()
        {
        ...
        public BottomRightL3x2(Point location) : base(location)
        {
            InitializeBlockMatrix();
            Draw();
            SetLeadBlock();
        ...
        {
            var shape = new BottomRightL3x2(this.Location);
            return shape;
        }
